...
PRJ_NAME=$1
OS_REQUIREMENTS_FILENAME="$PROJECT_HOME/$PRJ_NAME/requirements.apt"
...
function install_python()
{
    ...
    VIRTUALENV_PATH="$PROJECT_HOME/.env/bi"
    ...
    su -l vagrant -c "$VIRTUALENV_PATH/bin/python -m pip install -r $PROJECT_HOME/$PRJ_NAME/requirements.txt"
}
